...
class PostControllerTest {
    ...
    @Test
    @DisplayName("/v1/posts 요청시 title값은 필수다.")
    ...
    @Test
    @DisplayName("/v1/posts 요청시 DB에 값이 저장된다.")
    ...
    void test5() throws Exception {
        ...
        // expected
        mockMvc.perform(get("/v1/posts?page=1&size=10")
                        .contentType(APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    void test6() throws Exception {
        ...
        // expected
        mockMvc.perform(get("/v1/posts?page=0&size=10")
                        .contentType(APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()", is(10)))
                .andExpect(jsonPath("$[0].title").value("foo19"))
    ...
    void test7() throws Exception {
        ...
        // expected
        mockMvc.perform(patch("/v1/posts/{postId}", post.getId())
                        .contentType(APPLICATION_JSON)
